...
import {
    ...
    IoSettingsOutline,
    IoExitOutline,
    IoCreateOutline, IoBulbOutline, IoHeartCircleOutline, IoSearchOutline
} from 'react-icons/io5';
import {BiTimeFive, BiShieldQuarter, BiMessageDetail} from 'react-icons/bi';
import {FiSun, FiMoon, FiMessageCircle, FiBell} from 'react-icons/fi';
...
const ProfileSection = styled.h2`
    font-weight: 400;
    font-size: 16px;
    padding: 20px;
    border-radius: 8px;
...
const Button = styled.button`
    background-color: ${props => (props.outline ? 'transparent' : '#2CC295')};
    border: ${props => (props.outline ? '1px solid #000000' : 'none')};
    color: ${props => (props.outline ? '#000000' : '#000000')};
    padding: 14px 85px;
    border-radius: 16px;
    margin-top: 70px;
    cursor: pointer;
    ...
    return (
        <Container>
            ...
            <Main>
                ...
                <ProfileSection>
                    <h2>Профиль </h2>
                    <span>Фотография вашего профиля</span>
                    <Avatar
                        src="https://s3-alpha-sig.figma.com/img/f5a5/1a8d/53fec6c4babe799641facc912a50ee7e?Expires=1745193600&Key-Pair-Id=APKAQ4GOSFWCW27IBOMQ&Signature=LmSpoB4dYzhebAXgAv3eed6fLigICkH0QnWBt6yEWltve9~2UKxT-SMs8LO~JyuecIBOklixtu4ELeG9ynYcOkwakXaN4mSm0i2aQNVFIfu0BzcNlSMrfOB1YQFpujAc~79xppnTZl5SLoY3KV0SqZvw103muE1uyUNkUMS7f1OvXN88vAat2GCitgDlXb~YpM7UbeYVRdI9tq8KFmL8ni5fS0pGkXiSGAllXQ9ceuNIa69fZzFbUBLUiTbC0OFqn-L5k4NUkYhTDZL2BLyCfIGy~MXDKvwH~V-JiNJYj3aA1wlZwvQKzmy3PPe1ObOpmxqVelZu1NcVTbfnfOzh7A__"
                        alt="user"/>
                    <StyledPhotoButton>Поменять фото</StyledPhotoButton>
                    <StyledDivider/>
                    <InputGroup>
                        ...
                        <StyledInputField>
                            ...
                            <StyledInput placeholder="Введите вашу почту" />
                        </StyledInputField>
                    </InputGroup>
