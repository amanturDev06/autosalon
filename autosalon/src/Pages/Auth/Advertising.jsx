...
import {IoExitOutline, IoGiftOutline, IoPeopleOutline, IoSettingsOutline, IoStatsChartOutline, IoBulbOutline,  IoHeartCircleOutline,  IoCreateOutline,  IoSearchOutline } from "react-icons/io5";
import {BiEditAlt, BiMessageDetail, BiShieldQuarter, BiTimeFive,} from "react-icons/bi";
import {FiBell, FiMessageCircle, FiPhone, FiSun} from "react-icons/fi";
import { AiOutlineDelete } from "react-icons/ai";
import AdModal from "./AdModal.jsx";
import EditingModalWindow from "./EditingModalWindow.jsx";
...
const Advertising = () => {
    ...
    const handleAddAd = (newAd) => {
        ...
        setAdsList((prev) => [...prev, newAdWithId]);
        setIsModalOpen(false);
    };

    const handleDelete = (indexToDelete) => {
        const updatedAds = adsList.filter((_, index) => index !== indexToDelete);
        setAdsList(updatedAds);
    };

    const [adsList, setAdsList] = useState([
        { title: "Весенний апгрейд", startDate: "26.02.2025", endDate: "30.06.2025", status: "Активно", type: "Текстовый блок" },
        ...
        { title: "Авто в кредит", startDate: "12.02.2025", endDate: "08.04.2025", status: "Активно", type: "Карусель" },
        { title: "Рассрочка без переплат", startDate: "24.01.2025", endDate: "29.03.2025", status: "Активно", type: "Карусель" },
        { title: "Диагностика бесплано", startDate: "01.01.2025", endDate: "10.03.2025", status: "Активно", type: "Текстовый блок" },
        { title: "Зимняя акция", startDate: "28.12.2024", endDate: "01.02.2025", status: "Архив", type: "Баннер" },
        { title: "Лимитированная серия 2024", startDate: "26.12.2024", endDate: "20.01.2025", status: "Архив", type: "Карусель" },
        { title: "Кредит 0%", startDate: "12.11.2024", endDate: "15.01.2025", status: "Архив", type: "Баннер" },
        { title: "Скидка 15%", startDate: "21.09.2024", endDate: "31.12.2024", status: "Архив", type: "Мультиформат" },
        { title: "Рассрочка без переплат", startDate: "01.09.2024", endDate: "25.12.2024", status: "Архив", type: "Баннер" }
    ]);
        ...
        <Container>
            <Sidebar>
                ...
                <Nav>
                    ...
                    <NavItem $active={location.pathname === "/advertising"}>
            ...
            <Main>
                ...
                <Content style={{position: "relative"}}>
                    <Title style={{position: "sticky"}}>Редактирование рекламы
                        <AddButton onClick={() => setIsModalOpen(true)}>+ Добавить</AddButton>
                    </Title>
                            ...
                            <tr key={ad.id}>
                                ...
                                <td>
                                    ...
                                    <StyledIconButtons>
                                        ...
                                        <EditButton onClick={() => {
                                            setAdToEdit(ad); // передаём объект объявления
                                            setIsEditing(true);
                                            setIsModalOpen(true);
                                        }}>
                                            <BiEditAlt/>
                    ...
                    {/*{isModalOpen && <AdModal onClose={() => setIsModalOpen(false)} onSave={handleAddAd} />}*/}
                    {/*{isModalOpen && <AdModal onClose={() => setIsModalOpen(false)} />}*/}

                    {/*{isModalOpen && <EditingModalWindow onClose={() => setIsModalOpen(false)} />}*/}

                    {isModalOpen && !isEditing && (
                        <AdModal onClose={() => setIsModalOpen(false)} onSave={handleAddAd} />
                    )}
                    ...
                    {isModalOpen && isEditing && (
                        <EditingModalWindow
                            ...
                            onSave={(updatedAd) => {
                                ...
                                const updatedList = adsList.map((ad) =>
...
const EditButton = styled.button`
    ...
    height: 44px;
    border-radius: 8px;
    border: 1px solid #000000; // чёрный бордер
