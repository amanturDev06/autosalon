...
const IconPiEyeSlash=styled(PiEyeSlash)`
    font-size: 20px;
    color:#707070;
    position: absolute;
    right: 14px;
    top: 51%;
    transform: translateX(-1990%);
`;
...
function InpitWrapper() {
    return null;
}

function StyledInpitWrapper(props) {
    return null;
}
    ...
    return (
        <Container>
            <HeaderContainer>
                ...
                <StyledTitle2><svg width="142" height="42" viewBox="0 0 142 42" fill="none" xmlns="http://www.w3.org/2000/svg">
